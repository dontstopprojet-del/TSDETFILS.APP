            ...
            <div style={{background:C.card,borderRadius:'16px',padding:'20px',marginBottom:'15px'}}>
              ...
              <div style={{background:C.light,borderRadius:'12px',padding:'15px',marginBottom:'15px'}}>
                ...
                <div style={{marginBottom:'12px'}}>
                  ...
                  <div style={{fontSize:'15px',fontWeight:'600',color:C.text}}>TSDFILS SARLU</div>
                </div>
                <div>
        ...
        <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
          ...
          <div style={{padding:'15px'}}>
            ...
            <div style={{background:C.card,borderRadius:'16px',padding:'20px',marginTop:'15px'}}>
              <div style={{textAlign:'center'}}><Logo size={100} /><p style={{margin:'10px 0 5px',fontSize:'13px',fontWeight:'600',color:C.text}}>TSDFILS SARLU</p><p style={{margin:0,fontSize:'12px',color:C.textSecondary}}>RCCM: GN.TCC.2024.A.12345</p><p style={{margin:'5px 0 0',fontSize:'12px',color:C.textSecondary}}>NIF: 123456789</p></div>
            </div>
          </div>
          <Nav/>
        </div>
        ...
        <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
          ...
          <div style={{padding:'15px'}}>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              ...
              <Paragraph>{lang==='fr'?"Les présentes conditions générales d'utilisation régissent l'utilisation de l'application TSDFILS SARLU et les relations entre l'utilisateur (client ou technicien), l'application et TSDFILS SARLU.":"These terms of service govern the use of the TSDFILS SARLU application and the relationships between the user (client or technician), the application, and TSDFILS SARLU."}</Paragraph>
            </div>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
            ...
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              <SectionTitle icon="🏢" title={lang==='fr'?"Responsabilités de TSDFILS SARLU":"TSDFILS SARLU Responsibilities"}/>
            ...
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              ...
              <Paragraph>{lang==='fr'?"TSDFILS SARLU ne peut être tenu responsable des dommages indirects, pertes de données, ou interruptions de service indépendantes de sa volonté. En cas de litige, une solution amiable sera recherchée en priorité.":"TSDFILS SARLU cannot be held responsible for indirect damages, data loss, or service interruptions beyond its control. In case of dispute, an amicable solution will be sought first."}</Paragraph>
            </div>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              <SectionTitle icon="🚫" title={lang==='fr'?'Suspension de compte':'Account Suspension'}/>
              <Paragraph>{lang==='fr'?"TSDFILS SARLU se réserve le droit de suspendre ou supprimer un compte en cas de:":"TSDFILS SARLU reserves the right to suspend or delete an account in case of:"}</Paragraph>
          ...
          <div style={{padding:'15px'}}>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              ...
              <div style={{display:'flex',flexDirection:'column',gap:'10px'}}>
                ...
                <div style={{display:'flex',alignItems:'center',gap:'12px',padding:'12px',background:C.light,borderRadius:'10px'}}>
                  <span style={{fontSize:'24px'}}>🏦</span>
                  <div><p style={{margin:0,fontSize:'14px',fontWeight:'600',color:C.text}}>{t.bankTransfer}</p><p style={{margin:'2px 0 0',fontSize:'12px',color:C.textSecondary}}>BICIGUI - TSDFILS SARLU</p></div>
                </div>
                <div style={{display:'flex',alignItems:'center',gap:'12px',padding:'12px',background:C.light,borderRadius:'10px'}}>
                  <span style={{fontSize:'24px'}}>💵</span>
        ...
        <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
          ...
          <div style={{padding:'15px'}}>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              ...
              <BulletList items={lang==='fr'?['Annulation par TSDFILS SARLU','Travaux non conformes au devis (après expertise)','Double facturation (erreur technique)','Service non effectué']:['Cancellation by TSDFILS SARLU','Work not conforming to quote (after assessment)','Double billing (technical error)','Service not performed']}/>
            </div>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
        ...
        <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
          ...
          <div style={{padding:'15px'}}>
            ...
            <div style={{background:C.card,borderRadius:'16px',padding:'18px'}}>
              ...
              <BulletList items={lang==='fr'?["Allez dans les paramètres de votre téléphone","Sélectionnez TSDFILS SARLU dans la liste des applications","Désactivez l'autorisation de localisation","Vous pouvez aussi refuser lors de la demande d'autorisation"]:["Go to your phone settings","Select TSDFILS SARLU in the app list","Disable location permission","You can also refuse when prompted for authorization"]}/>
        ...
        <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
          ...
          <div style={{padding:'15px'}}>
            ...
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              ...
              <Paragraph>{lang==='fr'?"Vous restez propriétaire de tous les contenus que vous envoyez. En les partageant, vous accordez à TSDFILS SARLU une licence d'utilisation limitée pour:":"You remain the owner of all content you send. By sharing them, you grant TSDFILS SARLU a limited license to use for:"}</Paragraph>
        ...
        <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
          ...
          <div style={{padding:'15px'}}>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              ...
              <Paragraph>{lang==='fr'?"L'application TSDFILS SARLU agit comme plateforme de mise en relation entre clients et techniciens qualifiés. Elle facilite la prise de rendez-vous, le suivi des interventions et les paiements.":"The TSDFILS SARLU application acts as a platform connecting clients with qualified technicians. It facilitates appointment booking, intervention tracking, and payments."}</Paragraph>
            </div>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              <SectionTitle icon="👷" title={lang==='fr'?'Responsabilité des travaux':'Work Responsibility'}/>
              <Paragraph>{lang==='fr'?'Les travaux de plomberie sont effectués sous la responsabilité directe des techniciens certifiés TSDFILS SARLU. Chaque technicien est:':'Plumbing work is performed under the direct responsibility of certified TSDFILS SARLU technicians. Each technician is:'}</Paragraph>
            ...
            <div style={{background:C.card,borderRadius:'16px',padding:'18px'}}>
              ...
              <Paragraph>{lang==='fr'?'TSDFILS SARLU ne peut être tenu responsable pour:':'TSDFILS SARLU cannot be held responsible for:'}</Paragraph>
        ...
        <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
          ...
          <div style={{padding:'15px'}}>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              ...
              <Paragraph>{lang==='fr'?"La présente clause de non-concurrence vise à protéger les intérêts légitimes de TSDFILS SARLU et à préserver la confidentialité des informations commerciales et techniques.":"This non-competition clause aims to protect the legitimate interests of TSDFILS SARLU and preserve the confidentiality of commercial and technical information."}</Paragraph>
            </div>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              ...
              <BulletList items={lang==='fr'?['Ne pas solliciter directement les techniciens TSDFILS SARLU pour des travaux personnels en dehors de la plateforme','Ne pas divulguer les tarifs préférentiels ou informations commerciales obtenues','Ne pas reproduire ou copier les méthodes de travail propriétaires','Ne pas dénigrer publiquement TSDFILS SARLU ou ses employés']:['Not directly soliciting TSDFILS SARLU technicians for personal work outside the platform','Not disclosing preferential rates or commercial information obtained','Not reproducing or copying proprietary work methods','Not publicly disparaging TSDFILS SARLU or its employees']}/>
            </div>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
            ...
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              ...
              <Paragraph>{lang==='fr'?"La date de création de votre compte marque le début de votre relation contractuelle avec TSDFILS SARLU. Cette date anniversaire est importante pour:":"Your account creation date marks the beginning of your contractual relationship with TSDFILS SARLU. This anniversary date is important for:"}</Paragraph>
            ...
            <div style={{background:C.card,borderRadius:'16px',padding:'18px'}}>
              ...
              <Paragraph>{lang==='fr'?"En cas de violation de cette clause, TSDFILS SARLU se réserve le droit de:":"In case of violation of this clause, TSDFILS SARLU reserves the right to:"}</Paragraph>
      ...
      if(legalScreen==='confidentiality') return (
        <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
          ...
          <div style={{padding:'15px'}}>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              <SectionTitle icon="🔐" title={lang==='fr'?'Objet':'Purpose'}/>
              <Paragraph>{lang==='fr'?"La présente clause vise à protéger toutes les informations confidentielles échangées entre le client et TSDFILS SARLU.":"This clause aims to protect all confidential information exchanged between the client and TSDFILS SARLU."}</Paragraph>
            </div>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
        ...
        <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
          ...
          <div style={{padding:'15px'}}>
            <div style={{background:C.card,borderRadius:'16px',padding:'20px',marginBottom:'12px',textAlign:'center'}}>
              <Logo size={140}/>
              <h3 style={{margin:'15px 0 8px',fontSize:'18px',color:C.text}}>TSDFILS SARLU</h3>
            ...
            <div style={{background:C.card,borderRadius:'16px',padding:'18px'}}>
              ...
              <div style={{fontSize:'13px',color:C.text,lineHeight:'1.8'}}>
                <p style={{margin:'0 0 8px'}}><strong>Raison sociale:</strong> TSDFILS SARLU</p>
        ...
        setTimeout(async ()=>{
          try {
            ...
            if (userQuestion.includes('nom') || userQuestion.includes('name') || userQuestion.includes('entreprise') || userQuestion.includes('company')) {
              response = lang === 'fr'
                ? `Notre entreprise s'appelle ${companyInfo.name || 'TSDFILS SARLU'}. ${companyInfo.description || ''}`
                : `Our company name is ${companyInfo.name || 'TSDFILS SARLU'}. ${companyInfo.description || ''}`;
              ...
              response = lang === 'fr'
                ? `${companyInfo.name || 'TSDFILS SARLU'} a été fondée en ${companyInfo.founded || '2020'}.`
                : `${companyInfo.name || 'TSDFILS SARLU'} was founded in ${companyInfo.founded || '2020'}.`;
              ...
              response = chatbotContext || (lang === 'fr'
                ? `${companyInfo.name || 'TSDFILS SARLU'} est spécialisée dans les services de plomberie, d'installation et de maintenance. Nous offrons des solutions de qualité à nos clients.`
                : `${companyInfo.name || 'TSDFILS SARLU'} specializes in plumbing, installation, and maintenance services. We offer quality solutions to our clients.`);
              ...
              const responses = lang==='fr' ? [
                ...
                `${companyInfo.name || 'TSDFILS SARLU'} est là pour vous aider. Un conseiller vous répondra sous 24-48h.`,
              ] : [
                ...
                `${companyInfo.name || 'TSDFILS SARLU'} is here to help. An advisor will respond within 24-48h.`,
              ];
      ...
      if(legalScreen==='menu') return (
        <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
          ...
          <div style={{padding:'15px'}}>
            ...
            <div style={{background:C.card,borderRadius:'16px',padding:'20px',marginTop:'15px'}}>
              <div style={{textAlign:'center'}}><Logo size={100} /><p style={{margin:'10px 0 5px',fontSize:'13px',fontWeight:'600',color:C.text}}>TSDFILS SARLU</p><p style={{margin:0,fontSize:'12px',color:C.textSecondary}}>Espace Technicien</p></div>
            </div>
          </div>
          <Nav/>
        </div>
          ...
          <div style={{padding:'15px'}}>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              ...
              <ul style={{margin:0,paddingLeft:'20px'}}>
                {(lang==='fr'?['Respecter les horaires de rendez-vous','Fournir un travail de qualité','Porter l\'uniforme TSDFILS SARLU','Maintenir une conduite professionnelle','Documenter les interventions avec photos','Respecter les consignes de sécurité']:['Respect appointment schedules','Provide quality work','Wear TSDFILS SARLU uniform','Maintain professional conduct','Document interventions with photos','Follow safety guidelines']).map((item,i)=><li key={i} style={{fontSize:'13px',lineHeight:'1.6',color:C.text,marginBottom:'6px'}}>{item}</li>)}
              </ul>
            </div>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px'}}>
              <h4 style={{margin:'0 0 12px',fontSize:'15px',fontWeight:'600',color:C.primary}}>{lang==='fr'?'Engagements de TSDFILS SARLU':'TSDFILS SARLU Commitments'}</h4>
              <ul style={{margin:0,paddingLeft:'20px'}}>
        ...
        <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
          ...
          <div style={{padding:'15px'}}>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              ...
              <p style={{margin:0,fontSize:'13px',lineHeight:'1.6',color:C.text}}>{lang==='fr'?'Tous les techniciens sont couverts par l\'assurance responsabilité civile professionnelle de TSDFILS SARLU pendant les interventions.':'All technicians are covered by TSDFILS SARLU professional liability insurance during interventions.'}</p>
            </div>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px'}}>
        ...
        <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
          ...
          <div style={{padding:'15px'}}>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              ...
              <p style={{margin:'0 0 12px',fontSize:'13px',lineHeight:'1.6',color:C.text}}>{lang==='fr'?"En tant que technicien TSDFILS SARLU, vous vous engagez à:":"As a TSDFILS SARLU technician, you commit to:"}</p>
              <ul style={{margin:0,paddingLeft:'20px'}}>
                {(lang==='fr'?['Ne pas exercer d\'activité concurrente pendant la durée du contrat','Ne pas travailler directement pour les clients TSDFILS SARLU en dehors de la plateforme','Ne pas divulguer les secrets commerciaux, tarifs ou méthodes de travail','Ne pas débaucher d\'autres techniciens TSDFILS SARLU','Respecter l\'exclusivité pendant les heures de travail assignées']:['Not engage in competing activities during the contract period','Not work directly for TSDFILS SARLU clients outside the platform','Not disclose trade secrets, rates, or work methods','Not poach other TSDFILS SARLU technicians','Respect exclusivity during assigned work hours']).map((item,i)=><li key={i} style={{fontSize:'13px',lineHeight:'1.6',color:C.text,marginBottom:'6px'}}>{item}</li>)}
              </ul>
            </div>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              <h4 style={{margin:'0 0 12px',fontSize:'15px',fontWeight:'600',color:C.primary}}>{lang==='fr'?'Durée de la clause':'Clause Duration'}</h4>
              <p style={{margin:0,fontSize:'13px',lineHeight:'1.6',color:C.text}}>{lang==='fr'?"Cette clause de non-concurrence reste en vigueur pendant toute la durée de votre contrat avec TSDFILS SARLU, et pendant une période de 24 mois après la fin de la collaboration dans un rayon de 50 km autour de Conakry.":"This non-competition clause remains in effect throughout your contract with TSDFILS SARLU, and for a period of 24 months after the end of collaboration within a 50 km radius of Conakry."}</p>
            </div>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
            ...
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              ...
              <p style={{margin:'0 0 12px',fontSize:'13px',lineHeight:'1.6',color:C.text}}>{lang==='fr'?"En contrepartie de cette clause, TSDFILS SARLU s'engage à:":"In exchange for this clause, TSDFILS SARLU commits to:"}</p>
              <ul style={{margin:0,paddingLeft:'20px'}}>
          ...
          <div style={{flex:1,overflow:'auto',padding:'15px'}}>
            {chatMessages.length===0&&(
              <div style={{textAlign:'center',padding:'20px'}}>
                ...
                <p style={{fontSize:'14px',color:C.text,margin:'0 0 20px'}}>{lang==='fr'?'Support technique TSDFILS SARLU. Comment puis-je vous aider?':'TSDFILS SARLU technical support. How can I help you?'}</p>
              </div>
            )}
            {chatMessages.map(msg=>(
              <div key={msg.id} style={{display:'flex',justifyContent:msg.isBot?'flex-start':'flex-end',marginBottom:'12px'}}>
    ...
    <div style={{width:'100%',minHeight:'100vh',position:'relative',background:C.bg}}>
      ...
      {isLoggedIn && !showWelcome && (
        <>
          ...
          {currentUser && (userRole === 'admin' || userRole === 'tech' || userRole === 'client' || userRole === 'office' || userRole === 'shareholder' || userRole === 'partner') && (
            <button
