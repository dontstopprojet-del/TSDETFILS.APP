...
const IntelligentChatbot = ({ darkMode, lang, onClose, currentUser }: ChatbotProps) => {
  ...
  useEffect(() => {
    const welcomeMessage: ChatMessage = {
      id: Date.now(),
      text: lang === 'fr'
        ? '👋 Bonjour! Je suis votre assistant intelligent TSDFILS.\n\n✨ Je peux vous aider avec:\n• Informations sur nos services\n• Demandes de devis\n• Suivi de vos projets\n• Contact et urgences\n• Questions techniques\n\nComment puis-je vous aider aujourd\'hui?'
        : '👋 Hello! I am your TSDFILS intelligent assistant.\n\n✨ I can help you with:\n• Service information\n• Quote requests\n• Project tracking\n• Contact and emergencies\n• Technical questions\n\nHow can I help you today?',
      isBot: true,
