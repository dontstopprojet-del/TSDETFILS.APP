...
import MessagingSystem from './EnhancedMessagingSystem';
import IntelligentChatbot from './IntelligentChatbot';
import RealtimeNotifications from './RealtimeNotifications';
import AdminDashboardEnhanced from './AdminDashboardEnhanced';
import AuthenticatedQuoteForm from './AuthenticatedQuoteForm';
import ClientInvoicesScreen from './ClientInvoicesScreen';
import AuthenticatedQuoteTracker from './AuthenticatedQuoteTracker';
...
const TSDApp = ({ onBackToVisitor, isPasswordRecovery }: { onBackToVisitor?: () => void; isPasswordRecovery?: boolean }) => {
  ...
  const [_globalActiveCall, _setGlobalActiveCall] = useState<any>(null);
      ...
      try {
        ...
        if (session?.user) {
          ...
          if (appUser) {
            ...
            if (appUser.profile_photo) setProfilePhoto(appUser.profile_photo);
            if (appUser.cover_photo) setCoverPhoto(appUser.cover_photo);
          }
        }
      } catch (err) {
  ...
  const ClientApp = () => {
    ...
    if(screen==='home') return (
      <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
        ...
        <BroadcastBanner userRole="client" darkMode={darkMode} />
    ...
    if(screen==='profil') return (
      <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
        ...
        <div style={{padding:'0 15px'}}>
          ...
          <button onClick={handleLogout} style={{width:'100%',marginTop:'15px',background:'#FEE2E2',color:C.danger,border:`2px solid ${C.danger}`,padding:'16px',borderRadius:'14px',fontWeight:'bold',cursor:'pointer'}}>🚪 {t.logout}</button>
        </div>
        <Nav/>
      </div>
    );
            ...
            <div style={{background:C.card,borderRadius:'16px',padding:'20px',marginBottom:'15px'}}>
              ...
              <div style={{background:C.light,borderRadius:'12px',padding:'15px',marginBottom:'15px'}}>
                ...
                <div style={{marginBottom:'12px'}}>
                  ...
                  <div style={{fontSize:'15px',fontWeight:'600',color:C.text}}>TSDFILS SARL</div>
                </div>
                <div>
        ...
        <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
          ...
          <div style={{padding:'15px'}}>
            ...
            <div style={{background:C.card,borderRadius:'16px',padding:'20px',marginTop:'15px'}}>
              <div style={{textAlign:'center'}}><Logo size={100} /><p style={{margin:'10px 0 5px',fontSize:'13px',fontWeight:'600',color:C.text}}>TSDFILS SARL</p><p style={{margin:0,fontSize:'12px',color:C.textSecondary}}>RCCM: GN.TCC.2024.A.12345</p><p style={{margin:'5px 0 0',fontSize:'12px',color:C.textSecondary}}>NIF: 123456789</p></div>
            </div>
          </div>
          <Nav/>
        </div>
        ...
        <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
          ...
          <div style={{padding:'15px'}}>
            ...
            <div style={{background:C.card,borderRadius:'16px',padding:'18px'}}>
              ...
              <Paragraph>{lang==='fr'?'Pour exercer vos droits, contactez-nous à: privacy@TSDFILS.com':'To exercise your rights, contact us at: privacy@TSDFILS.com'}</Paragraph>
            </div>
          </div>
          <Nav/>
        </div>
        ...
        <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
          ...
          <div style={{padding:'15px'}}>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              ...
              <Paragraph>{lang==='fr'?"Les présentes conditions générales d'utilisation régissent l'utilisation de l'application TSDFILS et les relations entre l'utilisateur (client ou technicien), l'application et TSDFILS SARL.":"These terms of service govern the use of the TSDFILS application and the relationships between the user (client or technician), the application, and TSDFILS SARL."}</Paragraph>
            </div>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
            ...
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              <SectionTitle icon="🏢" title={lang==='fr'?"Responsabilités de TSDFILS":"TSDFILS Responsibilities"}/>
            ...
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              ...
              <Paragraph>{lang==='fr'?"TSDFILS ne peut être tenu responsable des dommages indirects, pertes de données, ou interruptions de service indépendantes de sa volonté. En cas de litige, une solution amiable sera recherchée en priorité.":"TSDFILS cannot be held responsible for indirect damages, data loss, or service interruptions beyond its control. In case of dispute, an amicable solution will be sought first."}</Paragraph>
            </div>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              <SectionTitle icon="🚫" title={lang==='fr'?'Suspension de compte':'Account Suspension'}/>
              <Paragraph>{lang==='fr'?"TSDFILS se réserve le droit de suspendre ou supprimer un compte en cas de:":"TSDFILS reserves the right to suspend or delete an account in case of:"}</Paragraph>
          ...
          <div style={{padding:'15px'}}>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              ...
              <div style={{display:'flex',flexDirection:'column',gap:'10px'}}>
                ...
                <div style={{display:'flex',alignItems:'center',gap:'12px',padding:'12px',background:C.light,borderRadius:'10px'}}>
                  <span style={{fontSize:'24px'}}>🏦</span>
                  <div><p style={{margin:0,fontSize:'14px',fontWeight:'600',color:C.text}}>{t.bankTransfer}</p><p style={{margin:'2px 0 0',fontSize:'12px',color:C.textSecondary}}>BICIGUI - TSDFILS SARL</p></div>
                </div>
                <div style={{display:'flex',alignItems:'center',gap:'12px',padding:'12px',background:C.light,borderRadius:'10px'}}>
                  <span style={{fontSize:'24px'}}>💵</span>
        ...
        <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
          ...
          <div style={{padding:'15px'}}>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              ...
              <BulletList items={lang==='fr'?['Annulation par TSDFILS','Travaux non conformes au devis (après expertise)','Double facturation (erreur technique)','Service non effectué']:['Cancellation by TSDFILS','Work not conforming to quote (after assessment)','Double billing (technical error)','Service not performed']}/>
            </div>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
        ...
        <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
          ...
          <div style={{padding:'15px'}}>
            ...
            <div style={{background:C.card,borderRadius:'16px',padding:'18px'}}>
              ...
              <BulletList items={lang==='fr'?["Allez dans les paramètres de votre téléphone","Sélectionnez TSDFILS dans la liste des applications","Désactivez l'autorisation de localisation","Vous pouvez aussi refuser lors de la demande d'autorisation"]:["Go to your phone settings","Select TSDFILS in the app list","Disable location permission","You can also refuse when prompted for authorization"]}/>
        ...
        <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
          ...
          <div style={{padding:'15px'}}>
            ...
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              ...
              <Paragraph>{lang==='fr'?"Vous restez propriétaire de tous les contenus que vous envoyez. En les partageant, vous accordez à TSDFILS une licence d'utilisation limitée pour:":"You remain the owner of all content you send. By sharing them, you grant TSDFILS a limited license to use for:"}</Paragraph>
        ...
        <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
          ...
          <div style={{padding:'15px'}}>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              ...
              <Paragraph>{lang==='fr'?"L'application TSDFILS agit comme plateforme de mise en relation entre clients et techniciens qualifiés. Elle facilite la prise de rendez-vous, le suivi des interventions et les paiements.":"The TSDFILS application acts as a platform connecting clients with qualified technicians. It facilitates appointment booking, intervention tracking, and payments."}</Paragraph>
            </div>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              <SectionTitle icon="👷" title={lang==='fr'?'Responsabilité des travaux':'Work Responsibility'}/>
              <Paragraph>{lang==='fr'?'Les travaux de plomberie sont effectués sous la responsabilité directe des techniciens certifiés TSDFILS. Chaque technicien est:':'Plumbing work is performed under the direct responsibility of certified TSDFILS technicians. Each technician is:'}</Paragraph>
            ...
            <div style={{background:C.card,borderRadius:'16px',padding:'18px'}}>
              ...
              <Paragraph>{lang==='fr'?'TSDFILS ne peut être tenu responsable pour:':'TSDFILS cannot be held responsible for:'}</Paragraph>
        ...
        <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
          ...
          <div style={{padding:'15px'}}>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              ...
              <Paragraph>{lang==='fr'?"La présente clause de non-concurrence vise à protéger les intérêts légitimes de TSDFILS SARL et à préserver la confidentialité des informations commerciales et techniques.":"This non-competition clause aims to protect the legitimate interests of TSDFILS SARL and preserve the confidentiality of commercial and technical information."}</Paragraph>
            </div>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              ...
              <BulletList items={lang==='fr'?['Ne pas solliciter directement les techniciens TSDFILS pour des travaux personnels en dehors de la plateforme','Ne pas divulguer les tarifs préférentiels ou informations commerciales obtenues','Ne pas reproduire ou copier les méthodes de travail propriétaires','Ne pas dénigrer publiquement TSDFILS ou ses employés']:['Not directly soliciting TSDFILS technicians for personal work outside the platform','Not disclosing preferential rates or commercial information obtained','Not reproducing or copying proprietary work methods','Not publicly disparaging TSDFILS or its employees']}/>
            </div>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
            ...
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              ...
              <Paragraph>{lang==='fr'?"La date de création de votre compte marque le début de votre relation contractuelle avec TSDFILS. Cette date anniversaire est importante pour:":"Your account creation date marks the beginning of your contractual relationship with TSDFILS. This anniversary date is important for:"}</Paragraph>
            ...
            <div style={{background:C.card,borderRadius:'16px',padding:'18px'}}>
              ...
              <Paragraph>{lang==='fr'?"En cas de violation de cette clause, TSDFILS se réserve le droit de:":"In case of violation of this clause, TSDFILS reserves the right to:"}</Paragraph>
      ...
      if(legalScreen==='confidentiality') return (
        <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
          ...
          <div style={{padding:'15px'}}>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              <SectionTitle icon="🔐" title={lang==='fr'?'Objet':'Purpose'}/>
              <Paragraph>{lang==='fr'?"La présente clause vise à protéger toutes les informations confidentielles échangées entre le client et TSDFILS.":"This clause aims to protect all confidential information exchanged between the client and TSDFILS."}</Paragraph>
            </div>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
        ...
        <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
          ...
          <div style={{padding:'15px'}}>
            <div style={{background:C.card,borderRadius:'16px',padding:'20px',marginBottom:'12px',textAlign:'center'}}>
              <Logo size={140}/>
              <h3 style={{margin:'15px 0 8px',fontSize:'18px',color:C.text}}>TSDFILS SARL</h3>
            ...
            <div style={{background:C.card,borderRadius:'16px',padding:'18px'}}>
              ...
              <div style={{fontSize:'13px',color:C.text,lineHeight:'1.8'}}>
                <p style={{margin:'0 0 8px'}}><strong>Raison sociale:</strong> TSDFILS SARL</p>
        ...
        setTimeout(async ()=>{
          try {
            ...
            if (userQuestion.includes('nom') || userQuestion.includes('name') || userQuestion.includes('entreprise') || userQuestion.includes('company')) {
              response = lang === 'fr'
                ? `Notre entreprise s'appelle ${companyInfo.name || 'TSDFILS'}. ${companyInfo.description || ''}`
                : `Our company name is ${companyInfo.name || 'TSDFILS'}. ${companyInfo.description || ''}`;
              ...
              response = lang === 'fr'
                ? `${companyInfo.name || 'TSDFILS'} a été fondée en ${companyInfo.founded || '2020'}.`
                : `${companyInfo.name || 'TSDFILS'} was founded in ${companyInfo.founded || '2020'}.`;
              ...
              response = chatbotContext || (lang === 'fr'
                ? `${companyInfo.name || 'TSDFILS'} est spécialisée dans les services de plomberie, d'installation et de maintenance. Nous offrons des solutions de qualité à nos clients.`
              ...
              const responses = lang==='fr' ? [
                ...
                `${companyInfo.name || 'TSDFILS'} est là pour vous aider. Un conseiller vous répondra sous 24-48h.`,
              ] : [
                ...
                `${companyInfo.name || 'TSDFILS'} is here to help. An advisor will respond within 24-48h.`,
              ];
  ...
  const TechApp = () => {
    ...
    if(screen==='home') return (
      <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px',position:'relative'}}>
        <div style={{position:'fixed',inset:0,backgroundImage:'url(/moi_et.jpeg)',backgroundSize:'cover',backgroundPosition:'center',opacity:0.39,zIndex:0,pointerEvents:'none'}} />
        ...
        <BroadcastBanner userRole="tech" darkMode={darkMode} />
        <div style={{padding:'15px'}}>
      ...
      if(legalScreen==='menu') return (
        <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
          ...
          <div style={{padding:'15px'}}>
            ...
            <div style={{background:C.card,borderRadius:'16px',padding:'20px',marginTop:'15px'}}>
              <div style={{textAlign:'center'}}><Logo size={100} /><p style={{margin:'10px 0 5px',fontSize:'13px',fontWeight:'600',color:C.text}}>TSDFILS SARL</p><p style={{margin:0,fontSize:'12px',color:C.textSecondary}}>Espace Technicien</p></div>
            </div>
          </div>
          <Nav/>
        </div>
        ...
        <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
          ...
          <div style={{padding:'15px'}}>
            ...
            <div style={{background:C.card,borderRadius:'16px',padding:'18px'}}>
              ...
              <p style={{margin:0,fontSize:'13px',lineHeight:'1.6',color:C.text}}>{lang==='fr'?'Vous pouvez accéder, modifier ou supprimer vos données en contactant privacy@TSDFILS.com':'You can access, modify, or delete your data by contacting privacy@TSDFILS.com'}</p>
            </div>
          </div>
          <Nav/>
        </div>
          ...
          <div style={{padding:'15px'}}>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              ...
              <ul style={{margin:0,paddingLeft:'20px'}}>
                {(lang==='fr'?['Respecter les horaires de rendez-vous','Fournir un travail de qualité','Porter l\'uniforme TSDFILS','Maintenir une conduite professionnelle','Documenter les interventions avec photos','Respecter les consignes de sécurité']:['Respect appointment schedules','Provide quality work','Wear TSDFILS uniform','Maintain professional conduct','Document interventions with photos','Follow safety guidelines']).map((item,i)=><li key={i} style={{fontSize:'13px',lineHeight:'1.6',color:C.text,marginBottom:'6px'}}>{item}</li>)}
              </ul>
            </div>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px'}}>
              <h4 style={{margin:'0 0 12px',fontSize:'15px',fontWeight:'600',color:C.primary}}>{lang==='fr'?'Engagements de TSDFILS':'TSDFILS Commitments'}</h4>
              <ul style={{margin:0,paddingLeft:'20px'}}>
        ...
        <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
          ...
          <div style={{padding:'15px'}}>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              ...
              <p style={{margin:0,fontSize:'13px',lineHeight:'1.6',color:C.text}}>{lang==='fr'?'Tous les techniciens sont couverts par l\'assurance responsabilité civile professionnelle de TSDFILS pendant les interventions.':'All technicians are covered by TSDFILS professional liability insurance during interventions.'}</p>
            </div>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px'}}>
        ...
        <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
          ...
          <div style={{padding:'15px'}}>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              ...
              <p style={{margin:'0 0 12px',fontSize:'13px',lineHeight:'1.6',color:C.text}}>{lang==='fr'?"En tant que technicien TSDFILS, vous vous engagez à:":"As a TSDFILS technician, you commit to:"}</p>
              <ul style={{margin:0,paddingLeft:'20px'}}>
                {(lang==='fr'?['Ne pas exercer d\'activité concurrente pendant la durée du contrat','Ne pas travailler directement pour les clients TSDFILS en dehors de la plateforme','Ne pas divulguer les secrets commerciaux, tarifs ou méthodes de travail','Ne pas débaucher d\'autres techniciens TSDFILS','Respecter l\'exclusivité pendant les heures de travail assignées']:['Not engage in competing activities during the contract period','Not work directly for TSDFILS clients outside the platform','Not disclose trade secrets, rates, or work methods','Not poach other TSDFILS technicians','Respect exclusivity during assigned work hours']).map((item,i)=><li key={i} style={{fontSize:'13px',lineHeight:'1.6',color:C.text,marginBottom:'6px'}}>{item}</li>)}
              </ul>
            </div>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              <h4 style={{margin:'0 0 12px',fontSize:'15px',fontWeight:'600',color:C.primary}}>{lang==='fr'?'Durée de la clause':'Clause Duration'}</h4>
              <p style={{margin:0,fontSize:'13px',lineHeight:'1.6',color:C.text}}>{lang==='fr'?"Cette clause de non-concurrence reste en vigueur pendant toute la durée de votre contrat avec TSDFILS, et pendant une période de 24 mois après la fin de la collaboration dans un rayon de 50 km autour de Conakry.":"This non-competition clause remains in effect throughout your contract with TSDFILS, and for a period of 24 months after the end of collaboration within a 50 km radius of Conakry."}</p>
            </div>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
            ...
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              ...
              <p style={{margin:'0 0 12px',fontSize:'13px',lineHeight:'1.6',color:C.text}}>{lang==='fr'?"En contrepartie de cette clause, TSDFILS s'engage à:":"In exchange for this clause, TSDFILS commits to:"}</p>
              <ul style={{margin:0,paddingLeft:'20px'}}>
        ...
        <div style={{height:'100%',background:C.gray,overflow:'auto',paddingBottom:'80px'}}>
          ...
          <div style={{padding:'15px'}}>
            <div style={{background:C.card,borderRadius:'16px',padding:'18px',marginBottom:'12px'}}>
              ...
              <a href="mailto:tech@TSDFILS.com" style={{textDecoration:'none',display:'block'}}>
                <div style={{display:'flex',alignItems:'center',gap:'12px',padding:'14px',background:C.light,borderRadius:'12px',cursor:'pointer',transition:'all 0.2s'}} onMouseOver={(e)=>e.currentTarget.style.background=C.secondary+'20'} onMouseOut={(e)=>e.currentTarget.style.background=C.light}>
                  <span style={{fontSize:'24px'}}>📧</span>
                  <div><p style={{margin:0,fontSize:'14px',fontWeight:'600',color:C.primary}}>tech@TSDFILS.com</p><p style={{margin:'2px 0 0',fontSize:'12px',color:C.textSecondary}}>{lang==='fr'?'Support technique - Cliquer pour envoyer email':'Technical support - Click to send email'}</p></div>
                </div>
              </a>
            </div>
          </div>
          ...
          <div style={{flex:1,overflow:'auto',padding:'15px'}}>
            {chatMessages.length===0&&(
              <div style={{textAlign:'center',padding:'20px'}}>
                ...
                <p style={{fontSize:'14px',color:C.text,margin:'0 0 20px'}}>{lang==='fr'?'Support technique TSDFILS. Comment puis-je vous aider?':'TSDFILS technical support. How can I help you?'}</p>
              </div>
            )}
            {chatMessages.map(msg=>(
              <div key={msg.id} style={{display:'flex',justifyContent:msg.isBot?'flex-start':'flex-end',marginBottom:'12px'}}>
  ...
  const handleAcceptGlobalCall = useCallback((_call: any) => {
...
{isLoggedIn && !showWelcome && userRole === 'partner' && (
  ...
  />
      ...
      {isLoggedIn && currentUser && (
        <NotificationProvider currentUser={currentUser} onAcceptCall={handleAcceptGlobalCall}>
