...
const WelcomeIntroPage = ({ lang, darkMode, onComplete, user, role }: WelcomeIntroPageProps) => {
  ...
  const getMessages = () => {
    ...
    if (lang === 'fr') {
      switch (role) {
        case 'client':
          return {
            title: "Bienvenue chez TSDFILS SARLU",
        ...
        case 'tech':
          return {
            ...
            subtitle: "TSDFILS SARLU - Gestion des Chantiers",
        ...
        case 'office':
          return {
            title: "Espace Bureau",
            subtitle: "TSDFILS SARLU - Administration",
            greeting: `Bonjour ${userName}`,
        ...
        case 'admin':
          return {
            ...
            subtitle: "TSDFILS SARLU - Administration Complète",
            greeting: `Bienvenue ${userName}`,
            intro: "Accès complet à tous les outils de gestion et d'administration de TSDFILS SARLU.",
            ...
            readyText: "Tous les outils nécessaires pour piloter TSDFILS SARLU et prendre les décisions stratégiques.",
      ...
      switch (role) {
        case 'client':
          return {
            title: "Welcome to TSDFILS SARLU",
        ...
        case 'tech':
          return {
            ...
            subtitle: "TSDFILS SARLU - Site Management",
        ...
        case 'admin':
          return {
            ...
            subtitle: "TSDFILS SARLU - Full Administration",
            greeting: `Welcome ${userName}`,
            intro: "Complete access to all TSDFILS SARLU management and administration tools.",
            ...
            readyText: "All the tools needed to manage TSDFILS SARLU and make strategic decisions.",
  ...
  return (
    <div style={{
      minHeight: '100vh',
      background: darkMode
        ? 'linear-gradient(160deg, #071e2e 0%, #0D4A6E 50%, #0A3D5C 100%)'
        : 'linear-gradient(160deg, #0D3B54 0%, #0D4A6E 40%, #0A3D5C 70%, #0e7490 100%)',
      display: 'flex',
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              position: 'absolute',
              inset: 0,
              background: 'linear-gradient(135deg, #00D4FF 0%, #0D4A6E 50%, #0891b2 100%)',
              borderRadius: '30px',
        ...
        <div style={{
          ...
          <div style={{
            ...
            textAlign: 'center',
            padding: '20px 15px',
            background: darkMode ? 'rgba(8, 145, 178, 0.2)' : 'rgba(255,255,255,0.5)',
            borderRadius: '15px',
